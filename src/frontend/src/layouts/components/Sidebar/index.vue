...
//Hide the vertical scroll bar when in top mode
...
.has-logo {
  .el-scrollbar {
    // 1% more is to prevent the white line of about 1px from being displayed at the bottom of the sidebar in left mode
    height: calc(101% - var(--v3-header-height));
  }
}

.el-scrollbar {
  // 1% more to prevent vertical scrolling in top mode
  height: 101%;
